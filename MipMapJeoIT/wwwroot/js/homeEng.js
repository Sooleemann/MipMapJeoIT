...
require([
    ...
    var gmlName = "CityGML_M-94560501-E__09.01.2025";//,CityGML_M-94560501-C__09.01.2025,CityGML_M-94560501-D__09.01.2025,CityGML_M-94560501-E__09.01.2025,CityGML_M-94560501-F__09.01.2025,CityGML_M-94560501-G__09.01.2025,CityGML_M-94560501-H__09.01.2025";// "M-25448841-A";// "M-25441739-A";//"F-3239548-1";// 
    ...
    let layerParsel = new FeatureLayer({
        ...
        fields: [
            ...
            {
                name: "parcelsAccessedList",
                type: "string"
            }
            , {
                name: "reasonForAccessedParcel",
                type: "string"
            }, {
                name: "cityName",
                type: "string"
        ...
        fetch(`/Home/ParselSorgu?lon=${lon}&lat=${lat}`)
            ...
            .then(function (data) {
                ...
                if (data.success) {
                    ...
                    Swal.fire("Query Parcel", data.msg, "warning");
    ...
    function buildingsContent(feature) {
        ...
        var fields = {
            "Area": "Area", "Height": "Height", "BuildingId": "Building Id", "gml_id": "GML ID", "roofProjectionArea": "Roof Projection Area", "blockNumber": "Block No",
            "buildingType": "Building Type", "constructionID": "Construction ID", "parcelNumber": "Parcel No", "takbisNeighbourhoodReference": "TAKBİS  Neighbourhood Reference",
            "takbisPropertyIdentityNumber": "TAKBİS PropertyIdentity Id", "tenderRegistrationNumber": "Registration Number", "Z_Min": "Minimum Height",
    ...
    function mimariRenderer() {
        ...
        const renderer = {
            ...
            },
            {
                ...
                label: "Building/Structure Entrance Door",
                symbol: {
                    type: "simple-fill",
                    color: [209, 101, 50, 1],
                    style: "solid",
    ...
    function showWeatherInPosition(position) {
        var apiUrl = `/api/services/GetWeather?lat=${position.latitude}&lon=${position.longitude}&appid=24a2e78f8adf4546c65fb79457295726&lang=en&units=metric`;
