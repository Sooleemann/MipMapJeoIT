...
[XmlRoot(ElementName = "dateAttribute", Namespace = "http://www.opengis.net/citygml/generics/2.0")]
...
public class Polygon
{
    ...
    [XmlAttribute(AttributeName = "id", Namespace = "http://www.opengis.net/gml")]
    public string Id { get; set; }
    [XmlElement(ElementName = "interior", Namespace = "http://www.opengis.net/gml")]
...
[XmlRoot(ElementName = "solidMember", Namespace = "http://www.opengis.net/gml")]
...
[XmlRoot(ElementName = "CompositeSolid", Namespace = "http://www.opengis.net/gml")]
public class CompositeSolid
{
    [XmlElement(ElementName = "solidMember", Namespace = "http://www.opengis.net/gml")]
    public SolidMember SolidMember { get; set; }
}

[XmlRoot(ElementName = "lod1Solid", Namespace = "http://www.opengis.net/citygml/building/2.0")]
public class Lod1Solid
{
    [XmlElement(ElementName = "CompositeSolid", Namespace = "http://www.opengis.net/gml")]
    public CompositeSolid CompositeSolid { get; set; }
...
public class LineString
{
    ...
    [XmlElement(ElementName = "posList", Namespace = "http://www.opengis.net/gml", IsNullable = true)]
    public PosList? PosList { get; set; }
...
public class Appearance
{
    ...
    public Appearance AppearanceContent { get; set; }
}

[XmlRoot(ElementName = "consistsOfBuildingPart", Namespace = "http://www.opengis.net/citygml/building/2.0")]
public class ConsistsOfBuildingPart
{
    [XmlElement(ElementName = "BuildingPart", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public BuildingPart BuildingPart { get; set; }
}


[XmlRoot(ElementName = "BuildingPart", Namespace = "http://www.opengis.net/citygml/building/2.0")]
...
public class BoundedBy2
{
    ...
    [XmlElement(ElementName = "GroundSurface", Namespace = "http://www.opengis.net/citygml/building/2.0", IsNullable = true)]
...
public class WallSurface
{
    ...
    [XmlElement(IsNullable = true, ElementName = "opening", Namespace = "http://www.opengis.net/citygml/building/2.0")]
...
public class Building
{
    ...
    [XmlElement(ElementName = "doubleAttribute", Namespace = "http://www.opengis.net/citygml/generics/2.0")]
    public List<DoubleAttribute> DoubleAttribute { get; set; }
    [XmlElement(ElementName = "dateAttribute", Namespace = "http://www.opengis.net/citygml/generics/2.0")]
    public DateAttribute DateAttribute { get; set; }
    [XmlElement(ElementName = "class", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public string Class { get; set; }
    [XmlElement(ElementName = "storeysAboveGround", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public string StoreysAboveGround { get; set; }
    [XmlElement(ElementName = "storeysBelowGround", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public string StoreysBelowGround { get; set; }
    [XmlElement(ElementName = "lod0FootPrint", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public Lod0FootPrint Lod0FootPrint { get; set; }
    [XmlElement(ElementName = "lod0RoofEdge", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public Lod0RoofEdge Lod0RoofEdge { get; set; }
    ...
    public List<OuterBuildingInstallation> OuterBuildingInstallation { get; set; }

    [XmlElement(ElementName = "consistsOfBuildingPart", Namespace = "http://www.opengis.net/citygml/building/2.0")]
    public List<ConsistsOfBuildingPart> ConsistsOfBuildingPart { get; set; }
...
[XmlRoot(ElementName = "lod2Geometry", Namespace = "http://www.opengis.net/citygml/generics/2.0")]
public class Lod2Geometry2
{
    [XmlElement(ElementName = "MultiSurface", Namespace = "http://www.opengis.net/gml")]
    public MultiSurface MultiSurface { get; set; }
}
...
public class GenericCityObject
{
    ...
    public Lod2Geometry2 Lod2Geometry2 { get; set; }
    [XmlAttribute(AttributeName = "id", Namespace = "http://www.opengis.net/gml")]
    public string Id { get; set; }
}
